...
export const getGraphQLType = (type: typeof GraphQLClassType | any): GraphQLType => {
    if (type.prototype instanceof GraphQLClassType || type instanceof List || type instanceof NonNull) {
        return type.gql;
    }
