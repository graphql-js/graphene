import {
    GraphQLObjectType, defaultFieldResolver, GraphQLResolveInfo, GraphQLFieldConfig, GraphQLOutputType, GraphQLInterfaceType } from "graphql";
import { Field, UnmountedFieldMap, MountedFieldMap, mountFields } from "./field";
...
export type ResolverFunction<T, R=any, A=ResolverArguments, C=any> = (root?: T, args?:A, context?:C, info?:GraphQLResolveInfo) => R;
...
export class ObjectType extends GraphQLClassType {
    ...
    static constructType(): GraphQLObjectType {
        const constructFields = () => {
            ...
            for (let fieldName in this.mountedFields) {
                ...
                graphqlFields[fieldName] = {
                    type: <GraphQLOutputType>getGraphQLType(field.type),
        ...
        return new GraphQLObjectType({
            ...
            interfaces: this.interfaces.map(_interface=><GraphQLInterfaceType>getGraphQLType(_interface)),
